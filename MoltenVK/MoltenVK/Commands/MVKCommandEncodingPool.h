...
#pragma mark Command resources
	...
	/** Returns a MTLComputePipelineState for converting indirect draws for geometry emulation. */
	id<MTLComputePipelineState> getCmdDrawIndirectGeometryConvertBuffersMTLComputePipelineState(bool indexed);
...
protected:
	...
	id<MTLComputePipelineState> _mtlDrawIndirectGeometryConvertBuffersComputePipelineState[2] = {nil, nil};
